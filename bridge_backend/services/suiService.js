...
const mint = async (recipientAddress, amount) => {
    ...
    console.log("MINTING SUI:", truncateAmount(amount), " MTR");

    const tx = new Transaction();
    tx.moveCall({
        target: `${SUI_PACKAGE_OBJECT_ID}::mtr_coin::mint`,
        arguments: [
...
const burn = async (senderAddress, amount) => {
    ...
    const balance = await client.getBalance({
        owner: senderAddress,
        coinType: `${SUI_PACKAGE_OBJECT_ID}::mtr_coin::MTR_COIN`,
    });
    ...
    console.log("BURNING  SUI: ", truncateAmount(amount), " MTR");

    const burnTx = new Transaction();
    burnTx.moveCall({
        target: `${SUI_PACKAGE_OBJECT_ID}::mtr_coin::burn`,
        arguments: [
